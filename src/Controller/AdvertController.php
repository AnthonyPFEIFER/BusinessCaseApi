...
class AdvertController extends AbstractController
{
    ...
    public function getAdvertById(SerializerInterface $serializer, $id)
    {
        ...
        $advert = $serializer->serialize($advert, 'json', ["groups" => $groupAdverts]);
    ...
    public function addAdvert(Request $request, SerializerInterface $serializer, $id)
    {
        ...
        $advertToAdd = $serializer->serialize($advert, 'json', ["groups" => $groupAdverts]);
    ...
    public function modify(SerializerInterface $serializer, Request $request, $id)
    {
        ...
        $groupAdverts = "adverts";
        $advertEdit = $serializer->serialize($advertEdit, 'json', ["groups" => $groupAdverts]);
    ...
    public function delete(SerializerInterface $serializer, Request $request, $id)
    {
        ...
        $groupAdverts = "adverts";
        $advert = $serializer->serialize($advertToDelete, 'json', ["groups" => $groupAdverts]);
        return new JsonResponse($advert, Response::HTTP_OK, [], true);
    }
    /**
     ...
     */
    public function filterAdvert(SerializerInterface $serializer, Request $request)
    {
        $fuel = $request->query->get('fuel');
        $dateImmat = $request->query->get('dateImmat');
        ...
        $adverts = $serializer->serialize($adverts, 'json', ['groups' => $groupAdverts]);
    ...
    public function edit(SerializerInterface $serializer, Request $request, $id)
    {
        $data = $request->getContent();
        $advertTrad = $serializer->deserialize($data, AdvertTrad::class, 'json');
